<?php
    ...
    $sql = "SELECT curso.id_curso, curso.nome_curso, tipo_curso.nome_tipo FROM curso INNER JOIN tipo_curso ON curso.id_tipo_curso = tipo_curso.id_tipo_curso WHERE curso.id_curso = ?";
