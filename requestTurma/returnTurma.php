<?php
    ...
    $valorSelecionado = $_POST['turma'];
    var_dump($valorSelecionado);

    $sql = "SELECT curso.nome_curso, curso.id_curso, turma.id_turma, turma.nome_turma, turma.horario_inicio, turma.horario_termino, turma.data_inicio FROM curso INNER JOIN turma ON curso.id_curso = turma.id_curso WHERE turma.id_turma = ?";
